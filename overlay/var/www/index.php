...
<html lang="en">
    <head>
        ...
        <title>TurnKey NGINX PostgreSQL PHP FastCGI Server</title>
    ...
    <body>
        <h1>TurnKey NGINX PostgreSQL PHP FastCGI Server</h1>
            ...
            <div id="cp">
                <div class="fragment-content">
                    ...
                    <ul>
                        ...
                        <!-- <li><a href="https://www.turnkeylinux.org/lepp">TurnKey appliance release notes</a></li> -->
                    </ul>
